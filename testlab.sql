...
-- Thời gian đã tạo: Th6 03, 2020 lúc 08:29 AM
...
(5, 14, 'Cường 1', 'Đúng', '2018-07-16 08:50:42', '2018-07-17 10:18:29'),
(6, 14, 'Cường 1', 'Sai', '2018-07-16 08:50:42', '2018-07-17 10:18:29'),
(7, 14, 'Cường 1', 'Sai', '2018-07-16 08:50:42', '2018-07-17 10:18:29'),
(8, 14, 'Cường 1', 'Sai', '2018-07-16 08:50:42', '2018-07-17 10:18:29'),
(9, 15, 'Xe 1', 'Đúng', '2018-07-16 10:31:29', '0000-00-00 00:00:00'),
(10, 15, 'Xe 2', 'Sai', '2018-07-16 10:31:29', '0000-00-00 00:00:00'),
(11, 15, 'Xe 3', 'Sai', '2018-07-16 10:31:29', '0000-00-00 00:00:00'),
(12, 15, 'Máy bay 1', 'Sai', '2018-07-16 10:31:29', '0000-00-00 00:00:00'),
(13, 16, 'RIP', ' Sai, mời bạn tìm hiểu thêm về RIP tại http://www.elabvn.com/elab/index.php/bai-viet?id=26', '2018-10-17 14:44:59', '2018-10-23 20:50:04'),
(14, 16, 'Static', 'Sai, mời bạn tìm hiểu thêm về Stactic tại http://www.elabvn.com/elab/index.php/bai-viet?id=35', '2018-10-17 14:44:59', '2018-10-23 20:50:04'),
(15, 16, 'BGP', 'Sai, mời bạn tìm hiểu thêm về BGP tại http://www.elabvn.com/elab/index.php/bai-viet?id=39', '2018-10-17 14:44:59', '2018-10-23 20:50:04'),
(16, 16, 'OSPF', 'Đúng', '2018-10-17 14:44:59', '2018-10-23 20:50:04'),
(17, 17, 'véc tơ khoảng cách', 'Sai, http://www.elabvn.com/elab/index.php/bai-viet?id=27', '2018-10-23 20:58:41', '0000-00-00 00:00:00'),
(18, 17, 'Trạng thái kết nối', 'Đúng', '2018-10-23 20:58:41', '0000-00-00 00:00:00'),
(19, 17, 'Do người quản trị cấu hình', 'Sai vì đây là giao thức định tuyến động', '2018-10-23 20:58:41', '0000-00-00 00:00:00'),
(20, 17, 'Dung lượng địa chỉ hop trên mạng', 'Sai, dung lượng địa chỉ hop không phải là metric để định tuyến', '2018-10-23 20:58:41', '0000-00-00 00:00:00');
...
INSERT INTO `comments` (`id`, `sender_id`, `room_id`, `content`, `created_at`, `avt`) VALUES
(250, 21, 21, 'Ngày thứ sáu 19/10 các lớp Mạng Không Dây Di Động nghỉ học', '2018-10-17 07:57:46', 'uploads/avts/39_2018/99aa9b173e502cf54c1bd0161b5c3221.JPG'),
(251, 21, 21, 'Lớp lập trình mobile sáng mai 24/10 P 201 b1 nghỉ nhé', '2018-10-23 08:17:17', 'uploads/avts/39_2018/99aa9b173e502cf54c1bd0161b5c3221.JPG'),
(252, 21, 21, 'ngày 31/10/2018 lớp lập trình mobile Tiết 1-3 phòng 201-B1 nghỉ học, dạy bù vào ngày 2/11/2018 tiết 4-6 phòng 401-B2', '2018-10-30 12:36:05', 'uploads/avts/39_2018/99aa9b173e502cf54c1bd0161b5c3221.JPG'),
(260, 40, 21, '', '2018-11-27 21:01:20', 'uploads/avts/43_2018/b9e463431bd6c156e89828ef4fae8448.jpeg');
...
--
-- Cấu trúc bảng cho bảng `livecodes`
--
...
--
-- Đang đổ dữ liệu cho bảng `livecodes`
--
...
INSERT INTO `location` (`id`, `user_id`, `lat`, `lng`, `created_at`) VALUES
(21, 21, '20.9950246', '105.8438075', '2019-03-31 10:01:28');
...
(26, 'Cấu hình XAMPP', '1', '<ol><li><strong>Cấu hình kết nối trang PHPMYADMIN</strong></li></ol><p>Để kết nối với trang <a href=\"http://elab/phpmyadmin\">http://elab/phpmyadmin</a> cấu hình file phpMyAdmin như hình sau</p><p>/* Authentication type and info */</p><p>$cfg[\'Servers\'][$i][\'auth_type\'] = \'config\';</p><p>$cfg[\'Servers\'][$i][\'user\'] = \'root\';</p><p>$cfg[\'Servers\'][$i][\'password\'] = \'xyz123\';</p><p>$cfg[\'Servers\'][$i][\'extension\'] = \'mysqli\';</p><p>$cfg[\'Servers\'][$i][\'AllowNoPassword\'] = true;</p><p>$cfg[\'Lang\'] = \'\';</p>', 21, '2017-11-29 16:52:18', '2020-06-03 04:55:24', 'uploads/avts/48_2017/3150a1926a6d97df4c73345bb58503f2.jpg', 245, 0, 0),
...
INSERT INTO `order` (`id`, `ipaddress`, `product_id`, `quantity`) VALUES
(26, '::1', 33, 1),
(27, '::1', 34, 1),
(28, '::1', 35, 1),
(29, '::1', 34, 1);
...
INSERT INTO `stocks` (`id`, `symbol`, `revenue`, `area`, `debt`, `stock`, `price`, `short_pro`, `profit`, `beta`, `dividend`, `kpi`, `state`, `updated_at`, `user_id`, `created_at`, `link`, `value`) VALUES
(7, 'PVS', 3703, 'Oil', 12466, 477, 12, 15451, 190, 1.76, 7, 5.3539482879106, '', '2020-05-02 14:51:24', 21, '2019-01-01 15:44:51', 'http://s.cafef.vn/hastc/PVS-tong-cong-ty-co-phan-dich-vu-ky-thuat-dau-khi-viet-nam.chn', 0.52148846960168),
(8, 'PVC', 553, 'Oil', 880, 50, 5.1, 1502, -8, 1.57, 1.8, 13.516124567474, '', '2020-03-14 21:51:39', 21, '2019-01-01 15:48:18', 'http://s.cafef.vn/hose/HBC-cong-ty-co-phan-tap-doan-xay-dung-hoa-binh.chn', 2.4392156862745),
(9, 'HBC', 4689, 'Construction', 10097, 230, 8, 12570, 203, 0.7, 7, 8.2321331521739, '', '2020-05-02 14:47:40', 21, '2019-01-01 15:51:53', 'http://s.cafef.vn/hose/HBC-cong-ty-co-phan-tap-doan-xay-dung-hoa-binh.chn', 1.3440217391304),
(10, 'LCG', 816, 'Construction', 2658, 98, 10.4, 2807, 42, 1.05, 7, 1.0331915680473, '', '2019-05-01 15:51:26', 21, '2019-01-02 09:21:37', 'http://s.cafef.vn/hose/LCG-cong-ty-co-phan-licogi-16.chn', 0.14619309262166),
(11, 'PLC', 1280, 'Gasolin', 3135, 80, 11.3, 3307, 27, 1.16, 17, 3.3203853081682, '', '2020-03-14 21:56:01', 21, '2019-01-02 09:41:59', 'http://s.cafef.vn/hastc/PLC-tong-cong-ty-hoa-dau-petrolimexctcp.chn', 0.19026548672566),
(12, 'CTD', 0, 'Construction', 6860, 78, 120, 13541, 473, 0.7, 30, 1.2491185897436, '', '2019-05-01 16:21:41', 21, '2019-01-05 15:45:56', 'http://s.cafef.vn/hose/CTD-cong-ty-co-phan-xay-dung-coteccons.chn', 0.71378205128205),
(13, 'DXG', 1200, 'Construction', 8658, 349, 18.8, 13731, 369, 1.02, 5, 2.0974610897591, '', '2019-07-24 14:27:36', 21, '2019-01-06 15:11:50', 'http://s.cafef.vn/hose/DXG-cong-ty-co-phan-tap-doan-dat-xanh.chn', 0.77318173504847),
(14, 'TCM', 1178, 'Textile', 1966, 54, 21.3, 1988, 96, 1.08, 5, 0.04849126055236, '', '0000-00-00 00:00:00', 21, '2019-01-06 15:32:26', 'http://s.cafef.vn/hose/TCM-cong-ty-co-phan-det-may-dau-tu-thuong-mai-thanh-cong.chn', 0),
(15, 'VCB', 54224, 'Bank', 933584, 3597, 54.4, 995111, 9091, 1.3, 8, 0.60111953516627, '', '0000-00-00 00:00:00', 21, '2019-01-06 16:22:06', 'http://s.cafef.vn/hose/VCB-ngan-hang-thuong-mai-co-phan-ngoai-thuong-viet-nam.chn', 0),
(16, 'SJS', 92, 'Estate', 4552, 115, 24, 4286, 9, 0.8, 10, -0.32125603864734, '', '2020-06-03 15:56:56', 21, '2019-01-19 11:16:19', 'http://s.cafef.vn/hose/SJS-cong-ty-co-phan-dau-tu-phat-trien-do-thi-va-khu-cong-nghiep-song-da.chn', -0.096376811594203),
(17, 'PHR', 352, 'Rubber', 1973, 135, 36, 1147, 177, 0.34, 20, -0.32103337905807, '', '0000-00-00 00:00:00', 21, '2019-01-19 11:37:21', 'http://s.cafef.vn/hose/PHR-cong-ty-co-phan-cao-su-phuoc-hoa.chn', 0),
(18, 'VCG', 2221, 'Estate', 12063, 441, 24.1, 12301, 185, 1.02, 8, 0.07582186125944, '', '2019-01-30 14:31:05', 21, '2019-01-19 11:45:47', 'http://s.cafef.vn/hastc/VCG-tong-cong-ty-co-phan-xuat-nhap-khau-va-xay-dung-viet-nam.chn', 0),
(19, 'GAS', 18512, 'Gasolin', 16081, 1913, 113, 40880, 3265, 1.73, 40, 0.70253571269644, '', '2019-04-24 11:55:38', 21, '2019-01-19 11:56:24', 'http://s.cafef.vn/hose/GAS-tong-cong-ty-khi-viet-namctcp.chn', 0.11472042707326),
(20, 'HPG', 14393, 'Steel', 57045, 2123, 25, 34134, 2408, 1.11, 15, -2.8749365991521, '', '2020-05-18 16:47:44', 21, '2019-01-24 17:53:38', 'http://s.cafef.vn/hose/HPG-cong-ty-co-phan-tap-doan-hoa-phat.chn', -0.43167216203486),
(21, 'DNH', 807, 'Electricity', 3210, 422, 25, 2395, 493, 1, 10, -0.30900473933649, '', '0000-00-00 00:00:00', 21, '2019-02-11 07:46:24', 'http://s.cafef.vn/upcom/DNH-cong-ty-co-phan-thuy-dien-da-nhim-ham-thuan-da-mi.chn', 0),
(22, 'VGS', 2015, 'Steel', 1130, 42, 8, 1448, 9, 0.73, 10, 8.6361607142857, '', '2020-05-02 14:44:36', 21, '2019-02-13 10:18:17', 'http://s.cafef.vn/hastc/VGS-cong-ty-co-phan-ong-thep-viet-duc-vg-pipe.chn', 0.94642857142857),
(23, 'CTR', 5000, 'Telecom', 1582, 60, 27.2, 2151, 180, 1.76, 10, 2.2559832756632, '', '2020-03-30 19:14:30', 21, '2020-03-30 19:07:58', 'https://s.cafef.vn/upcom/CTR-tong-cong-ty-co-phan-cong-trinh-viettel.chn', 0.34865196078431);
...
(6, 'Test 3', 21, 'uploads/avts/42_2018/402c5f397c3d5bf35f3090589e1b9995.jpg', '2018-10-17 15:16:42', '0000-00-00 00:00:00'),
(7, 'hung', 21, '', '2020-04-30 20:53:17', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `top_slider`
--
...
--
-- Đang đổ dữ liệu cho bảng `top_slider`
--
...
(21, '', 'scorpnet', '802dddbab919fe58ad6f1bc95ddb2e7a', NULL, NULL, 'phamhungevn@gmail.com', '', '', '', 0, 'uploads/avts/39_2018/99aa9b173e502cf54c1bd0161b5c3221.JPG', 1, NULL, '14.177.152.107', 0, 0, NULL, '2018-07-31 11:00:18', '2020-06-03 15:53:10', '', ''),
...
--
-- AUTO_INCREMENT cho bảng `livecodes`
--
ALTER TABLE `livecodes`
...
--
ALTER TABLE `location`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2422;
...
--
-- AUTO_INCREMENT cho bảng `top_slider`
--
ALTER TABLE `top_slider`
