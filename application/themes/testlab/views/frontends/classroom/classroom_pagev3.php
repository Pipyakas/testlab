					...
					<div class="wrapper">
						...
						?>
								...
								<div id="livecode">
									...
									<form class="form-horizontal col-sm-12" id="form" name="form" method="post" action="<?php echo base_url(); ?>index.php/testlab/friends/edit_apply" enctype="multipart/form-data">
