      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="controls col-sm-8 multi_select">
            <div class="checkbox">
              <label>
                <input type="checkbox" class="types" name="types[]" value="1">Listening
              </label>
            </div>
            <div class="checkbox">
              <label>
                <input type="checkbox" class="types" name="types[]" value="2">Reading
              </label>
            </div>
            <div class="checkbox">
              <label>
                <input type="checkbox" class="types" name="types[]" value="3">Speaking
              </label>
            </div>
            <div class="checkbox">
              <label>
                <input type="checkbox" class="types" name="types[]" value="4">Writing
              </label>
            </div>
          </div>
        </div>
