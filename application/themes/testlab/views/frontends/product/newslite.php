                    ...
                    <div class="row">
                        <div id="newslist">
                            <a class="thumb col-sm-7 col-xs-12" href="">
                                <img class="img-fluid" src="<?php if ($key->avt != null) {
                            ...
                            <div class="info col-sm-5 col-xs-12">
                                ...
                                <a href="<?php echo base_url() . 'index.php/classroom?id=' . $author[0]->id; ?>" class="btn btn-success" onclick="return check_login();">By <?php echo $author[0]->user_name; ?>
                                </a>
                                <a href="<?php echo base_url() . 'index.php/news?id=' . $key->id; ?>" class="btn btn-primary">See more</a>
                                <?php
