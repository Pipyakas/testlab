...
<section class="content">
	...
	<div class="row">
			...
			<div class="small-box bg-yellow">
				<div class="inner">
					<h3>
						  ...
						  <?php echo count($info['user_total']); ?>
		...
		<div class="col-lg-4 col-xs-6">
			...
			<div class="small-box bg-red">
				<div class="inner">
					<h3>
						<?php echo count($info['products_total']); ?>
					</h3>
					<p>
				...
				<a href="<?php echo base_url() ?>admin/products" class="small-box-footer">
					<?php echo lang('msg_more_info'); ?> <i class="fa fa-arrow-circle-right"></i>
				</a>
			</div>
		</div><!-- ./col -->
	...
	<div class="row wrapper">
		<div class="col-xs-12 col-md-6">
			<div class="page-header"><h3><?php echo lang('msg_lastest_products');  ?></h3></div>
			<table class="table table-bordered">
				...
				<tbody>
					...
					if($info['products']!=null)
						foreach($info['products'] as $r){
							?>
							<tr>
								<td><?php echo $r->id;?></td>
								<td><?php echo $r->title;?></td>
								<td><?php echo $r->types_id;?></td>
								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a href="<?php echo base_url().'admin/products/deactivated?id='.$r->id;?>"><?php echo lang('msg_deactivated'); ?></a></li>
											<li><a href="<?php echo base_url().'admin/products/activated?id='.$r->id;?>"><?php echo lang('msg_activated'); ?></a></li>
											<li><a href="<?php echo base_url().'admin/products/edit_get?id='.$r->id;?>"><?php echo lang('msg_edit');?></a></li>
											<li><a href="<?php echo base_url().'admin/products/delete?id='.$r->id;?>" onclick="return confirm('<?php echo lang('msg_confirm_delete'); ?>')"><?php echo lang('msg_delete');?></a></li>
										</ul>
									</div>
								</td>
							</tr>
