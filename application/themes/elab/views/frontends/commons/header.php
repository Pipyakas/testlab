            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse col-sm-6 col-xs-6" aria-expanded="false" id="navbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a class="navbar-brand" href="<?php echo base_url() . 'index.php/test?id=21' ?>">Test</a></li>
                ...
                <div class="navbar-brand col-sm-5 col-xs-7 outer" style="float:right">
                    ...
                    <a href="#" class="dropdown-toggle col-sm-1 col-xs-4" style="float:right" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">User</a>
                    <ul class="dropdown-menu pull-right" aria-labelledby="dropdownMenu1">
                        <?php if (isset($_SESSION['user'])) { ?>
                            <li><a href="<?php echo base_url() . 'index.php/dang-tin' ?>" style="color:black;">Đăng
                                    tin</a></li>
                            <li><a href="<?php echo base_url() . 'index.php/add-class' ?>" style="color:black;">Create
                                    classroom</a></li>
                            <li><a href="<?php echo base_url() . 'index.php/update-user' ?>" style="color:black;">Update
                                    user profile</a></li>
