<div id="content" class="container">
    <div class="core col-md-10 col-md-offset-1">
        ...
        <?php foreach ($news as $key){ ?>
            <div class="itemnews">
                <div class="row">
                    <a class="thumb col-sm-5" href="<?php echo base_url().'index.php/bai-viet?id='.$key->id; ?>">
                        <img src="<?php if($key->avt!=null){echo base_url().$key->avt;}else{echo base_url().'statics/images/logo.png';} ?>" alt="">
                    </a>
