       ...
       <div id="content">
         <div class="col-md-12" style="padding:0px;margin:0px;">
            <div class="item-news">
                <div class="row">
                    <div id="newslist" >
                        <a class="thumb col-sm-7 col-xs-12" style="padding-left:5px; padding-right:0px;margin:0px;" href="">
                             <img class="img-responsive" src="<?php if($key->avt!=null){echo base_url().$key->avt;} ?>" alt="">
                      
                        </a>
                        <div class="info col-sm-5 col-xs-12" style="padding-left:5px;padding-right:0px;margin:0px;">
                            <a href="<?php echo base_url().'index.php/bai-viet?id='.$key->id; ?>">
                             ...
                             <a href="<?php echo base_url().'index.php/classroom-page?id='.$author[0]->id; ?>">
