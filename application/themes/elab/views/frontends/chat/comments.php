                  ...
                  <div class="row">      
                   ...
                   <!--  <div class="container-fluid"> -->
                        <div class="col-sm-12 col-xs-12" style="padding-right:0px;">
                            ...
                            <div class="chat-message pull-right col-sm-9 col-xs-9" style="padding-right:0px;"><div style="float:right"> 
                ...
                <div class="row">
                  ...
                  <!--   <div class="container-fluid"> -->
                        <div class="col-sm-12 col-xs-12" style="padding-right:0px;">
                            ...
                            <div class="chat-message-left col-sm-9 col-xs-9"><div style="float:left"> <?php echo $key -> content;?></div>
