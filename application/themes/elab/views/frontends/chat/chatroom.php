   ...
   if (isset($livecodes)&& $livecodes!=null){
    foreach ($livecodes as $object) {
      ...
      <div id="webRTC" class="col-sm-4">
          <iframe id="the_iframe" src="http://192.168.1.9:5000#<?php echo $_SESSION['user'][0]->id; ?>;" width="100%" height="250px" frameborder="0"></iframe>
         <div class="flex-chat">
          <ul  id="messages"></ul>
           <div id="messageinput">
           <input id="m"/>
...
#messageinput button {
  ...
  .flex-row {
    ...
    /*    var iframe = document.createElement('iframe');
        ...
        //   $('#messages').append($('<divclass="pull-right receivedmess">'+e.data+'</div>'));
