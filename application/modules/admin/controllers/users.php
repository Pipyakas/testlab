...
class Users extends Backend_Controller{
	...
	function index(){
		...
		$base_url=base_url().'index.php/admin/users';
...
public function remote_edit(){
		...
		$brand=$this->input->post('brand');
			...
			if(isset($_POST['types'])){
				...
				$data_array['gu_types_id']	=$types_string;
			  
			 
			}
			//print_r($data_array);
            $this->users_model->update($data_array,array('id'=>$id));
            redirect(base_url().'gu-cua-ban');
