...
class Dashboard extends MY_Controller{
	...
	function index(){
		...
		$data['info']['products']=$this->news_model->get("*,news.id as id", false,  false,  0, 10, array('news.created_at'=>'DESC'));
...
*/
		...
		$data['info']['products_total']=$this->news_model->total(array(),array());
	...
	function login(){
		...
		$this->utils->_load_view('backends/login',$view_data);
	}
